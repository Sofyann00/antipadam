...
export async function POST(request: Request) {
  try {
    ...
    const mailOptions = {
      from: 'admin@pulsahub.net',
      to,
      subject: 'Purchase Confirmation - pulsahub',
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
          <div style="text-align: center; margin-bottom: 30px;">
            <img src="https://pulsahub.net/app_icon.png" alt="pulsahub Logo" style="width: 150px; height: auto; margin-bottom: 20px;">
          </div>
